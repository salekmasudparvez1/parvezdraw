import { DEFAULT_TRANSFORM_HANDLE_SPACING } from "@prof/common";
import {
  pointFrom,
  pointRotateRads,
  type GlobalPoint,
...
import type { EditorInterface } from "@prof/common";

import type { ExcalidrawTextElement } from "@prof/element/types";
