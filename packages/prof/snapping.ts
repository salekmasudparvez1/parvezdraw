...
import { TOOL_TYPE, KEYS } from "@prof/common";
import {
  getCommonBounds,
...
import { getMaximumGroups } from "@prof/element";
...
import type { InclusiveRange } from "@prof/math";

import type { Bounds } from "@prof/common";
import type { MaybeTransformHandleType } from "@prof/element";
import type {
  ElementsMap,
  ExcalidrawElement,
