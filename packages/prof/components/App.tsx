...
import type { GlobalPoint, LocalPoint, Radians } from "@prof/math";
...
import type { Mutable, ValueOf } from "@prof/common/utility-types";
...
class App extends React.Component<AppProps, AppState> {
  ...
  public updateScene = withBatchedUpdates(
    <K extends keyof AppState>(sceneData: {
       ...
       *
       * Check [API docs](https://docs.excalidraw.com/docs/@prof/core/api/props/excalidraw-api#captureUpdate) for more details.
       *
