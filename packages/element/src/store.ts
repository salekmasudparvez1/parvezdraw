...
import type App from "@prof/core/components/App";

import type { DTO, ValueOf } from "@prof/common/utility-types";

import type { AppState, ObservedAppState } from "@prof/core/types";
